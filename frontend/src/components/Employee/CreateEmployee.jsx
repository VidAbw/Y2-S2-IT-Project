...
const CreateEmployee = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (validate()) {
            try {
                const res = await axios.post('http://localhost:5000/employees/create', employee);
                ...
                setMessage(`Error creating employee: ${error.response.data.error}`);
            }
        }
    };

    // Handle input change and remove corresponding validation error
    const handleChange = (e) => {
        ...
        // Clear the error for the current field if it becomes valid
        ...
        <div className="container mt-5">
            <div className="row justify-content-center">
                <div className="col-lg-6 col-md-8 col-sm-10">
                    <h2 className="text-center mb-4" style={{ color: '#FFA500', fontWeight: 'bold' }}>Create Employee</h2>
